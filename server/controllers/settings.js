const Prferences = require("../models/Preferences")
...
exports.profileCreate = [
	...
	// callback that returns error or handles return function
	function(req, res) {
		const errors = validationResult(req);
		if (!errors.isEmpty()) {
